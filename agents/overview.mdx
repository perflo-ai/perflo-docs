...
Withdrawing to an external address you have not approved is also impossible for an agent — that always requires a fresh confirmation from you.

## How working with an agent actually goes

1. **Connect** your AI app once — a five-minute setup.
