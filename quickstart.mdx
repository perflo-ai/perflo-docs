...
<Steps>
  <Step title="Create your account">
    [Open the app](https://app.perfolio.ai), enter your email, then type the 6-digit code we send you. That code is your login. Never share it with anyone, including anyone claiming to be Perflo support.
