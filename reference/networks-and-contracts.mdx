...
|---|---|---|---|
| Ethereum | 1 | Stablecoin deposits, cash, assets (WBTC, WETH, XAUT), swaps, Earn, Borrow | [etherscan.io](https://etherscan.io) |
| Base | 8453 | Stablecoin deposits, agent pay-per-call payments (x402) | [basescan.org](https://basescan.org) |
...
Stablecoin deposits are accepted on Ethereum and Base only. The app always shows which networks are valid for a given deposit.
