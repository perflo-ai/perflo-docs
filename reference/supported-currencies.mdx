...
Standing stablecoin deposit addresses are available on **Ethereum, Base, Optimism, Polygon, Avalanche, Solana, and Tron**, and incoming stablecoins can convert straight into your balance. Stablecoin transfers out are gasless for you; the app shows the valid networks for every deposit and send.
