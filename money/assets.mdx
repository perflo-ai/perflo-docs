...
**Goal:** own assets directly from your cash balance, from small amounts. You need a verified, funded account, and investing features unlock once your balance passes a minimum threshold (see [Guardrails](/concepts/guardrails)).
